 ...
 */
public class PLAK_RemoveRule<C extends AbstractRevisorConsolePLAK<C, ?, ?, ?>> extends PLAK_EditRuleSet<C> {
	
	// Constructors :
	
	public PLAK_RemoveRule(C console, String inputText, PLAK_RuleSetIdentifier<C> identifier, Expression<C, PLAK_Rule<C>> rule) {
